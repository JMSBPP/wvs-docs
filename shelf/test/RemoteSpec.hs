...
live step cfg dir = do
  ...
  smallSha <- upload cfg smallKey (dir </> "small.pdf") (blob 1024)
  ...
  bigSha <- upload cfg bigKey (dir </> "big.pdf") (blob (1024 * 1024))
...
upload :: RemoteConfig -> Text -> FilePath -> BS.ByteString -> IO Sha256
