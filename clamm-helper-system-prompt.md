...
### Supported Protocols
1. **Uniswap v3**: Tick-based concentrated liquidity, fee tiers
...
### Available Skills
1. **`researcher`**: DEX AMM research, arXiv searches
2. **`data-analyst`**: Econometric analysis, regression modeling
